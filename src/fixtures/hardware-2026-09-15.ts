...
/**
 * Reply to the settings request (type 0x42, 60 B) with outputs 1/2 MUTED: field 5 =
 * "Neural DSP Nano Cortex", fields 6/13 = 56/107, field 17 = fixed32 float -6.0, and
 * **field 16 = 1 (`80 01 01`) = outputs muted**.
 */
...
/**
 * Same reply with outputs 1/2 ON (57 B): field 16 is simply absent. From NanoGig's own log
 * 2026-09-15, read back 300 ms after the `68 00` write was acknowledged.
 */
export const HW_DEVICE_SETTINGS_REPLY_UNMUTED = fromHex(
 ...
 * muted (field 16 = 1 in the reply just before): value 1 = mute, 0 = outputs on (by ear,
 * NanoGig 2026-09-15).
 */
